...
@maxLength(90)
param resourceGroupName string = 'dep-${namePrefix}-cdn.profiles-${serviceShort}-rg-1'
  ...
  for iteration in ['init', 'idem']: {
    ...
    params: {
      ...
      customDomains: [
        ...
        // The below setup with a customized cipher suite effectively deploys the resources but generates an internal error of domain validation in Azure which is not due to the module
